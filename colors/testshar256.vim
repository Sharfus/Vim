...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Normal", "dcaa19", "080300", "")

    " highlight groups
    " red4 fg 
    call <SID>X("Cursor", "8b0000", "f4a460", "")
    "CursorIM
    "Directory
    "DiffAdd
    "DiffChange
    ...
    call <SID>X("NonText", "addbe7", "080300", "bold")
    call <SID>X("Question", "00ff7f", "", "")
    call <SID>X("Search", "f5deb3", "cd853f", "")
    call <SID>X("SpecialKey", "9acd32", "", "")
    call <SID>X("StatusLine", "643200", "fffafa", "reverse")
    call <SID>X("StatusLineNC", "643200", "7f7f7f", "reverse")
    ...
    hi StatusLine    cterm=bold,reverse ctermfg=brown ctermbg=yellow
    hi StatusLineNC  cterm=reverse ctermfg=brown ctermbg=yellow
